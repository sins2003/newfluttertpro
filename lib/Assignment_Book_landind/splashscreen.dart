...
void main(){
  runApp(MaterialApp(home: splashscreenBook(),debugShowCheckedModeBanner: false,));
}
...
class _splashscreenBookState extends State<splashscreenBook> {
  ...
  void initState() {
    Timer(Duration(seconds: 5),(){
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>LoginBook()));
    });
